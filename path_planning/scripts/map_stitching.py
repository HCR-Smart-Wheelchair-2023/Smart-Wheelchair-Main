...
class MapStitcher:
    ...
    def merge_maps(self):
        ...
        x_max = int(self.dynamic_map.info.origin.position.x + int(self.dynamic_map.info.height/2))
        y_min = int(self.dynamic_map.info.origin.position.y - int(self.dynamic_map.info.width/2))
        y_max = int(self.dynamic_map.info.origin.position.y + int(self.dynamic_map.info.width/2))
        rospy.loginfo(f'{x_min},{x_max},{y_min},{y_max},{self.dynamic_map.info.height}')
        static_array[(x_min+500):(x_max+500),(y_min+500):(y_max+500)] += map_array
