            ...
            if cread:
                try:
                    ...
                    if evbuf:
                        ...
                        elif evbuf[8:10].decode() == ' :':
                            if evbuf[10:12].decode() == '01':
                                # cansend(cansocket, "061#40100000")
                                # cansend(cansocket, "061#00110000")
                                cansend(cansocket, "061#40000000")
                                cansend(cansocket, "061#00010000")
                            if evbuf[10:12].decode() == '02':
                                # cansend(cansocket, "061#40110000")
                                # cansend(cansocket, "061#00100000")
                                cansend(cansocket, "061#40010000")
                                cansend(cansocket, "061#00000000")
                            if evbuf[10:12].decode() == '03':
                                cansend(cansocket, "181C0D00#0840085008440840")
