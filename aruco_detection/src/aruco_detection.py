...
class ArUcoCameraController:
    ...
    def aruco_markerArray_callback(self, markerArray):
        ...
        aruco_orientation_euler[0], aruco_orientation_euler[1], aruco_orientation_euler[2] = aruco_orientation_euler[1], aruco_orientation_euler[2], aruco_orientation_euler[1]
