...
class MapStitcher:
    ...
    def merge_maps(self):
        ...
        y_min = int(float(self.dynamic_map.info.origin.position.y - 0.8) / 0.05)
        y_max = int(float(self.dynamic_map.info.origin.position.y - 0.8) / 0.05 + self.dynamic_map.info.width)
