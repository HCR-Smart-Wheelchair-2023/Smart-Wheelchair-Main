...
class MapStitcher:
    ...
    def merge_maps(self):
        ...
        x_min = int(float(self.dynamic_map.info.origin.position.x + 1) / 0.05)
        x_max = int(float(self.dynamic_map.info.origin.position.x + 1) / 0.05 + self.dynamic_map.info.height)
        y_min = int(float(self.dynamic_map.info.origin.position.y - 0.5) / 0.05)
        y_max = int(float(self.dynamic_map.info.origin.position.y - 0.5) / 0.05 + self.dynamic_map.info.width)
