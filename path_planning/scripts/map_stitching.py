...
class MapStitcher:
    ...
    def merge_maps(self):
        ...
        x_min = self.dynamic_map.info.origin.position.x - int(self.dynamic_map.info.height/2)
        x_max = self.dynamic_map.info.origin.position.x - ceil(self.dynamic_map.info.height/2)
        y_min = self.dynamic_map.info.origin.position.y - int(self.dynamic_map.info.width/2)
        y_max = self.dynamic_map.info.origin.position.y - ceil(self.dynamic_map.info.width/2)
